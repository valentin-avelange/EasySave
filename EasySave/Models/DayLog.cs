namespace EasySave.Models
{
    ...
    public class DayLog : Logs
    {
        ...
        public DayLog(string name, SaveState state, DateTime timestampSave, bool saveType, string sourcePathFile, string targetPathFile, long currentFileSize, long durationFileTransfer)
        {
            Name = name;
            State = state;
